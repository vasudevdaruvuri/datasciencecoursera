...
==========================================
Created by Vasudev Daruvuri on February 29, 2016
...
```{r}
setwd("F:/Analytics/Moocs/DS-Coursera/Exercise/ReproducibleResearch/")
...
```{r}
if (!"stormData" %in% ls()) {
    stormData <- read.csv("F:/Analytics/Moocs/DS-Coursera/Exercise/ReproducibleResearch/stormData.csv", sep = ",")
}
dim(stormData)
head(stormData, n = 2)
```
...
fatalitiesPlot <- qplot(EVTYPE, data = fatalities, weight = FATALITIES) + 
    ...
    stat_count(width=1, colour="white", geom="bar")
